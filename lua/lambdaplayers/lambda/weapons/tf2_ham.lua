table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_ham = {
        model = "models/lambdaplayers/tf2/weapons/w_ham.mdl",
        origin = "Team Fortress 2",
        prettyname = "Ham",
        holdtype = "melee",
        bonemerge = true,

        killicon = "lambdaplayers/killicons/icon_tf2_ham",
        keepdistance = 10,
        attackrange = 45,        
		islethal = true,
        ismelee = true,
        ...
        OnDeploy = function( self, wepent )
            ...
            wepent:SetWeaponAttribute( "HitSound", ")weapons/holy_mackerel3.wav" )
