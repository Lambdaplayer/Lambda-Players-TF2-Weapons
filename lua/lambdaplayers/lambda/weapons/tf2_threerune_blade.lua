...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_threerune_blade = {
        model = "models/lambdaplayers/tf2/weapons/w_threerune_blade.mdl",
        origin = "Team Fortress 2",
        prettyname = "Threerune Blade",
        holdtype = "melee",
        bonemerge = true,

        killicon = "lambdaplayers/killicons/icon_tf2_three_rune_blade",
        keepdistance = 10,
        attackrange = 80,        
		islethal = true,
        ismelee = true,
        ...
        OnDeploy = function( self, wepent )
            ...
            local newHP = Round( self:GetMaxHealth() * 1.00 )
