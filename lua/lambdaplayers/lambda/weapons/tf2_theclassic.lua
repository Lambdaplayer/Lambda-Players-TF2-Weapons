...
local bulletTbl = {
    TracerName = "tfc_sniper_distortion_trail",
    Num = 1
}

table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_theclassic = {
        model = "models/lambdaplayers/tf2/weapons/w_tfc_sniperrifle.mdl",
        origin = "Team Fortress 2",
        prettyname = "The Classic",
        holdtype = {
        ...
        OnDeploy = function( self, wepent )
            ...
            wepent:SetWeaponAttribute( "Sound", ")weapons/sniper_rifle_classic_shoot.wav" )--placeholder
            wepent:SetWeaponAttribute( "CritSound", ")weapons/sniper_rifle_classic_shoot_crit.wav" )
