...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_csgo_awp = {
        model = "models/lambdaplayers/tf2/weapons/w_csgo_awp.mdl",
        origin = "Team Fortress 2",
        prettyname = "AWper Hand",
        holdtype = {
        ...
        bonemerge = true,
        killicon = "lambdaplayers/killicons/icon_tf2_hitmans_heatmaker", --doesn't Have its own Killicon i guess?
        ...
        OnDeploy = function( self, wepent )
            ...
            wepent:SetWeaponAttribute( "Sound", ")weapons/csgo_awp_shoot.wav" )
            wepent:SetWeaponAttribute( "CritSound", ")weapons/csgo_awp_shoot_crit.wav" )
