table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_apocofist = {
        model = "models/lambdaplayers/tf2/weapons/w_apoco_fists.mdl",
        origin = "Team Fortress 2",
        prettyname = "Apoco Fist",
        holdtype = "fist",
        bonemerge = true,
        dropondeath = false,

        killicon = "lambdaplayers/killicons/icon_tf2_apoco_fist", --sadly he doent's have its own killicon on lambda material folder :(
        keepdistance = 10,
        attackrange = 45,        
		islethal = true,
        ismelee = true,
