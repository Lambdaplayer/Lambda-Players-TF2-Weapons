...
table.Merge( _LAMBDAPLAYERSWEAPONS, { --nah my bro Got valve tf2 Weps :Skull:
    tf2_valve_rocketlauncher = {
        model = "models/lambdaplayers/tf2/weapons/w_rocket_launcher.mdl",
        origin = "Team Fortress 2",
        prettyname = "Valve Rocket Launcher",
        holdtype = "rpg",
        bonemerge = true,
        ...
        OnDeploy = function( self, wepent )
            ...
            wepent:SetWeaponAttribute( "Damage", 10099000 )
            wepent:SetWeaponAttribute( "RateOfFire", { 0.3, 0.3 } )
