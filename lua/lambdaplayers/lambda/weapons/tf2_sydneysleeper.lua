...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_syndey_sleeper = {
        model = "models/lambdaplayers/tf2/weapons/w_sydney_sleeper.mdl",
        origin = "Team Fortress 2",
        prettyname = "Sydney Sleeper",
        holdtype = {
        ...
        bonemerge = true,
        killicon = "lambdaplayers/killicons/icon_tf2_sydney_sleeper",
        ...
        OnDeploy = function( self, wepent )
            ...
            wepent:SetWeaponAttribute( "Sound", ")weapons/sniper_sydneysleeper_shoot.wav" )
            wepent:SetWeaponAttribute( "CritSound", ")weapons/sniper_sydneysleeper_shoot_crit.wav" )
